...
class RecordViewModel(app: App) : AndroidViewModel(app.getApplication()) {

    private val TRIGGER_TIME = "TRIGGER_AT"
    private val second: Long = 1000L

    private var prefs = app.getApplication().getSharedPreferences("com.freekickr.logic", Context.MODE_PRIVATE)
    ...
    private suspend fun loadTime() = withContext(Dispatchers.IO) {
